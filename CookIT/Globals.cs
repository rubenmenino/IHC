...
namespace CookIT
{
    static class Globals
    {
        ...
        public static void InitListaReceitas()
        {
            ...
            recipe bmilkshake = new recipe("Banana Milkshake", bmilkLi, "Milkshake", "Put the milk and banana into a blender. Whizz everything up until smooth then pour into a tall glass");
            recipe pasta = new recipe("Pasta", pastaLi, "Pastas", "Boil water in a large pot. Use at least 4 quarts of water for every pound of pasta. Salt the water with at least a tablespoon—more is fine. The salty water adds flavor to the pasta.  Add and stir the pasta.  Test the pasta by tasting it.  Drain the pasta and you're done.");
            ...
            Globals.receitas.Add(bmilkshake);
            Globals.receitas.Add(pasta);
